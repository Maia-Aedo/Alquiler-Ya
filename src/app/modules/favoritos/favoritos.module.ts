...
@NgModule({
  ...
  imports: [CommonModule, FavoritosRoutingModule],  // Importar CommonModule para usar directivas como ngIf y ngFor  Los módulos que este módulo necesita importar. Como estamos usando directivas como *ngFor, necesitamos importar CommonModule.
